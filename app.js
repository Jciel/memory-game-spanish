...
var $author$project$Main$imageCards = _List_fromArray(
	[
		A4(
...
var $author$project$Main$getCardId = function (card) {
	if (card.$ === 'Image') {
		var imageCard = card.a;
		return imageCard.id;
	} else {
		var descriptionCard = card.a;
		return descriptionCard.id;
	}
};
var $author$project$Main$compareCardIds = F2(
	function (cardA, cardB) {
		return _Utils_eq(
			$author$project$Main$getCardId(cardA),
			$author$project$Main$getCardId(cardB)) ? $author$project$Main$Correct : $author$project$Main$Wrong;
	});
var $author$project$Main$FlippedIn = function (a) {
	return {$: 'FlippedIn', a: a};
};
var $author$project$Main$flippedCardUpdate = F2(
	function (card, model) {
		if (card.$ === 'Image') {
			var imageCard = card.a;
			var toggleFlipped = function (cardInList) {
				var _v1 = cardInList.flipped;
				if (_v1.$ === 'FlippedIn') {
					return _Utils_update(
						cardInList,
						{
							flipped: $author$project$Main$FlippedOut('flippedOut')
						});
				} else {
					return _Utils_eq(cardInList.id, imageCard.id) ? _Utils_update(
						cardInList,
						{
							flipped: $author$project$Main$FlippedIn('flippedIn')
						}) : cardInList;
				}
			};
			var newListCards = A2($elm$core$List$map, toggleFlipped, model.imageCards);
			return _Utils_update(
				model,
				{imageCards: newListCards});
		} else {
			var descriptionCard = card.a;
			var toggleFlipped = function (cardInList) {
				var _v2 = cardInList.flipped;
				if (_v2.$ === 'FlippedIn') {
					return _Utils_update(
						cardInList,
						{
					...
					return _Utils_eq(cardInList.id, descriptionCard.id) ? _Utils_update(
						cardInList,
						{
							flipped: $author$project$Main$FlippedIn('flippedIn')
						}) : cardInList;
			...
			var newListCards = A2($elm$core$List$map, toggleFlipped, model.descriptionCards);
			return _Utils_update(
				model,
				{descriptionCards: newListCards});
		}
	});
...
var $author$project$Main$removeCards = F2(
	function (maybeCard, model) {
		if (maybeCard.$ === 'Just') {
			var card = maybeCard.a;
			if (card.$ === 'Image') {
				var imageCard = card.a;
				var newListImageCard = A2(
					$elm$core$List$filter,
					function (modelImageCard) {
						return !_Utils_eq(modelImageCard.id, imageCard.id);
					},
					model.imageCards);
				return _Utils_update(
					model,
					{imageCards: newListImageCard});
			} else {
				var descriptionCard = card.a;
				var newListDescriptionCard = A2(
					$elm$core$List$filter,
					function (modelDescriptionCard) {
						return !_Utils_eq(modelDescriptionCard.id, descriptionCard.id);
					},
					model.descriptionCards);
				return _Utils_update(
					model,
					{descriptionCards: newListDescriptionCard});
			}
		} else {
			return model;
		}
	});
var $author$project$Main$Description = function (a) {
	return {$: 'Description', a: a};
};
var $author$project$Main$Image = function (a) {
	return {$: 'Image', a: a};
};
var $author$project$Main$selectedCardUpdate = F2(
	function (card, model) {
		if (card.$ === 'Image') {
			var imageCard = card.a;
			return _Utils_update(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('button-result btn-success'),
							$elm$html$Html$Events$onClick($author$project$Main$RemoveCards)
						]),
					_List_fromArray(
						[
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('button-result btn-wrong')
						]),
					_List_fromArray(
						[
...
var $author$project$Main$FlipCard = function (a) {
	return {$: 'FlipCard', a: a};
};
var $author$project$Main$classActive = function (flipped) {
	if (flipped.$ === 'FlippedIn') {
		var status = flipped.a;
		return status;
	} else {
		var status = flipped.a;
		return status;
...
var $author$project$Main$mountDescriptionCard = function (descriptionCard) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class(
				$author$project$Main$classActive(descriptionCard.flipped) + ' description-card'),
				$elm$html$Html$Events$onClick(
				$author$project$Main$FlipCard(
					$author$project$Main$Description(descriptionCard)))
			]),
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('text-container front')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('back-detail')
									]),
								_List_Nil)
							])),
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$text(descriptionCard.description)
							]))
					]))
			]));
};
...
var $author$project$Main$mountImageCard = function (imageCard) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class(
				$author$project$Main$classActive(imageCard.flipped) + ' image-card'),
				$elm$html$Html$Events$onClick(
				$author$project$Main$FlipCard(
					$author$project$Main$Image(imageCard)))
			]),
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$src('public/images/' + imageCard.imagePath)
									]),
								_List_Nil),
								A2(
								$elm$html$Html$span,
								...
								_List_fromArray(
									[
										$elm$html$Html$text(imageCard.name)
									]))
							]))
					]))
			]));
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('cards-container')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('frame-description-cards')
							]),
						A2($elm$core$List$map, $author$project$Main$mountDescriptionCard, model.descriptionCards)),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('frame-image-cards')
							]),
						A2($elm$core$List$map, $author$project$Main$mountImageCard, model.imageCards))
					]))
			]));
};
